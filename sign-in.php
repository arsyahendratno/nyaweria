...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>NYAWERIA</b></a>
        </div>
        <div class="card">
            <div class="body">
                ...
                if(isset($login)){
                  $password=mysqli_real_escape_string($con, md5($_POST['password']));
                    if(mysqli_num_rows(mysqli_query($con,"select id from user where username='$username' and password='$password'")))
                    {
                      $tipe=mysqli_fetch_row(mysqli_query($con,"select id  from user where username='$username' and password='$password'"));
                ...
                <form id="sign_in" action="" method="POST">
                    <div class="msg">Login untuk memulai donasi</div>
